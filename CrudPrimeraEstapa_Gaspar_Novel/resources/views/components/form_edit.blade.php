...
<fieldset>
    ...
    <div class="row d-flex justify-content-center align-items-center">
        ...
        <div class="form-group col-7 col-xl-4 m-3 text-white">
            <label>Favicon: </label>
            <label class="ml-1"> Si
    ...
    <div class="row d-flex justify-content-center align-items-center">
            <div class="form-group col-7 col-xl-4 m-3 ">
                <label class="text-white">{{ __('traduccion.Image') }}: 
                    <img class="w-75 pt-1 pb-2" src="/imagenes/{{ $usuario->imagen}}">
            ...
            <button type="submit" class="btn btn-success bg-success">@lang('traduccion.Edit User')</button>
        </div>
    </div>
